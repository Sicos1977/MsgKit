...
namespace MsgWriter.Enums
{
    ...
    internal enum StoreSupportMask : uint
    {
        ...
        ///     use the value 0x0001 instead.
        /// </summary>
        STORE_HTML_OK = 0x0001,
        ...
        /// </summary>
        STORE_MV_PROPS_OK = 0x0200,

        /// <summary>
        ///     The message store supports notifications.
        /// </summary>
        STORE_NOTIFY_OK = 0x0100,
